...
contract RRECScript is Script {
	string public constant NAME   = "Democratic Republic of the Congo R-REC";                   // Replace with token name
	string public constant SYMBOL = "RREC-ACD";                          // Replace with token symbol
