...
contract RenewviaRECTest is Test {
    ...
    function testBlacklist() public {
        ...
        // Add to blacklist
        BlacklistableUpgradeable blacklistable = BlacklistableUpgradeable(address(token));
        
        vm.expectEmit(true, false, false, true);
        emit BlacklistAdded(blacklistedUser);
        
        blacklistable.addToBlacklist(blacklistedUser);
        ...
        token.transfer(blacklistedUser, 100 * 10**18);
    }
    ...
    function testBlacklistFailsFromNonOwner() public {
        ...
        vm.prank(user1);
        vm.expectRevert("Ownable: caller is not the owner");
        blacklistable.addToBlacklist(user2);
    }
    ...
    function testRemoveFromBlacklist() public {
        ...
        vm.expectEmit(true, false, false, true);
        emit BlacklistRemoved(blacklistedUser);
        ...
        assertEq(token.balanceOf(blacklistedUser), 500 * 10**18);
    ...
    function testPermit() public {
        ...
        assertEq(token.balanceOf(user1WithPk), 900 * 10**18);
