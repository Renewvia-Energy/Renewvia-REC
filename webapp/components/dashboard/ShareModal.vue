    ...
    >
      <div class="relative w-full max-w-2xl my-8">
        ...
        <div data-rex-modal-chrome class="flex items-center justify-between mb-3 px-1">
          <p class="text-sm font-semibold text-white">Impact Certificate</p>
        ...
        <div
          ref="certRef"
          class="rounded-xl shadow-2xl overflow-hidden p-8"
          style="background: white;"
        >
          <DashboardImpactCertificate
            :company="company"
            :wallet="wallet"
            :assets="contractsStore.assets"
            :total-mwh="contractsStore.totalMwh"
            :total-tco2e="contractsStore.totalTco2e"
            :total-retired-mwh="contractsStore.totalRetiredMwh"
            :total-retired-tco2e="contractsStore.totalRetiredTco2e"
...
function doPrint() {
  // Inject print-specific override: show only the modal content, hide everything else
